...
→ 방식 폐기. 대신 **BFF가 브라우저를 프로세스 수명 동안 직접 띄운 채 유지**하고, 사용자가 그 창에서 직접 로그인하는 구조로 바꿨습니다. (초기엔 20초 keep-alive 폴링으로 세션을 갱신했으나, 페이지를 열어둔 상태에서 15분 유휴 후에도 세션이 유지됨을 실측으로 확인해 제거했습니다.)
